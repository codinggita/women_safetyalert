...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-red-400 to-secondary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-lg text-white/80 mb-8">
            Access your safety dashboard and stay protected wherever you go.
          </p>
